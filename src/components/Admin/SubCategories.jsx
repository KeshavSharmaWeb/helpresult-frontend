...
const SubCategories = () => {
    ...
    const handleCancel = async (id) => {
        ...
        axios.post(url + "/delete-sub-category", { id: id, userId: localStorage.getItem('userId') }).then(res => {
            if (res.status === 200) {
    ...
    const handleUpdate = async (id, name) => {
        ...
        axios.post(url + "/update-sub-category", { id: id, userId: localStorage.getItem('userId'), name: name }).then(res => {
            if (res.status === 200) {
    ...
    const handleFormSubmit = async (e) => {
        ...
        axios.post(url + "/add-sub-category", data).then(res => {
            if (res.status === 200) {
    ...
    const AddNewCategory = () => {
        return (
            <Container style={{ width: "50%", marginTop: 30, marginBottom: 30 }}>
                <h3 style={{ textAlign: "center" }}>Add new Sub-category</h3>
